...
#property_type sector  bedRoom bahroom balcony  agePossession built_up_area servant room
...
built_up_area=float(st.number_input('Built Up Area (max lim 8000 sqft)'))
...
if st.button('Predict'):
    # form a dataframe
    data=[[property_type,sector,bedrooms,bathroom,
           balcony,property_age,built_up_area,servant_room
           ,store_room,furnishing_type,luxury_category,
           floor_category]]

    columns=['property_type','sector','bedRoom','bathroom',
             'balcony','agePossession','built_up_area','servant room','store room','furnishing_type',
